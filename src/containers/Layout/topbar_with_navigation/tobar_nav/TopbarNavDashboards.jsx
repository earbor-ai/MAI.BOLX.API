...
const TopbarNavDashboards = () => (
  <UncontrolledDropdown className="topbar__nav-dropdown">
    ...
    <DropdownMenu className="topbar__nav-dropdown-menu dropdown__menu">
      <DropdownItem>
        <TopbarNavLink title="Online Marketing Dashboard" icon="home" route="/finance_dashboard" />
      </DropdownItem>
      <DropdownItem>
      ...
      <DropdownItem>
        <TopbarNavLink title="Finance Dashboard" icon="rocket" route="/online_marketing_dashboard" />
      </DropdownItem>
      <DropdownItem>
