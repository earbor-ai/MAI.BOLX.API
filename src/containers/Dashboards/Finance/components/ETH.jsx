...
const ETH = ({ dir, clickEvent, style }) => {
  const [activeIndex] = useState(0);

  return (
    <Col md={12} xl={3} lg={6} xs={12} onClick={clickEvent} style={{ cursor: 'pointer' }}>
      <Card>
        <CardBody className="dashboard__card-widget financeCard" style={style}>
          <div className="card__title">
            <h5 className="bold-text">Total PO Receipts</h5>
            <h5 className="subhead">Receipts</h5>
          </div>
